...
class Letters():
        ...
        while True:
            ...
            if option == 'c':
                if len(self.consonants) >= 6:
                    print(Fore.RED + "You've reached your limit of 6 consonants" + Style.RESET_ALL)
                    continue
                else:
                ...
                if len(self.vowels) >= 5:
                    print(Fore.RED + "You've reached your limit of 5 vowels" + Style.RESET_ALL)
                    continue
                else:
            ...
            print(Fore.GREEN + f"* {' '.join(l.capitalize() for l in self.letters)} *" + Style.RESET_ALL)
    ...
    def load_dictionary(self):
        ...
        return set(word.strip() for word in open(dictonary) if len(word) <= 9 and len(word) > 1)
